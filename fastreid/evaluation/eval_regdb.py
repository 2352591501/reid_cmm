...
def eval_regdb(query_feats, query_ids, query_cam_ids, gallery_feats, gallery_ids, gallery_cam_ids, rerank=False, logger=None):
    ...
    logger.info(perf.format(r1, r10, r20, mAP))
