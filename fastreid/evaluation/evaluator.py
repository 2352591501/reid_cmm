...
def inference_on_dataset(model, fine_tune_org, parsing_net, data_loader, evaluator, flip_test=False):
    """
    ...
    with inference_context(model), torch.no_grad():
        for idx, inputs in enumerate(data_loader):
            ...
            outputs, outputs_mask = model(inputs, parsing_net, fine_tune_org)
            # Flip test
            if flip_test:
            ...
            evaluator.process(inputs, outputs, outputs_mask)
