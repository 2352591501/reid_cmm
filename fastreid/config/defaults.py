...
_C.MODEL.BACKBONE.IBM_STAGE = 0
_C.MODEL.BACKBONE.DSBN = False
...
_C.DATALOADER.BiMOD_BICAMERA_WAY = False
...
_C.DATALOADER.ONLY_VISIBLE = False
_C.DATALOADER.ONLY_INFRAD = False
...
_C.SOLVER.PARSING_LR_FACTOR = 1.0
