...
from fastreid.engine.memory import Memory
from fastreid.engine.Patch_memory import PatchMemory
import weakref
import collections
...
class SimpleTrainer(TrainerBase):
    ...
    def __init__(self, model, data_loader, optimizer, param_wrapper, optimizer_parsing, cfg, parsing_net, fine_tune_org):
        """
        Args:
        ...
        self.optimizer_parsing = optimizer_parsing
        self.parsing_net = parsing_net
        self.fine_tune_org = fine_tune_org
        self.cfg = cfg
    ...
    def run_step(self):
        ...
        loss_dict = self.model(data, self.parsing_net, self.fine_tune_org, self.iter)
...
class AMPTrainer(SimpleTrainer):
    ...
    """
    def __init__(self, model, data_loader, optimizer, param_wrapper, optimizer_parsing, cfg, parsing_net, fine_tune_org, grad_scaler=None):
        """
        ...
        super().__init__(model, data_loader, optimizer, param_wrapper, optimizer_parsing, cfg, parsing_net, fine_tune_org)
    ...
    def run_step(self):
        ...
        self.optimizer.zero_grad()
        #self.optimizer_parsing.zero_grad()
